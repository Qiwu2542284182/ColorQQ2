...
public final class AnyLayer {
     ...
     */
    public AnyLayer contentAnim(final LayerManager.IAnim contentAnim) {
        if (contentAnim != null) {
     ...
     */
    public AnyLayer backgroundAnim(final LayerManager.IAnim backgroundAnim) {
    ...
    public AnyLayer backgroundColorRes(@ColorRes int colorRes) {
        mLayerManager.mConfig.mBackgroundColor = mLayerManager.mContext.getResources().getColor(colorRes);
        return this;
    }
     ...
     * @param viewIds  控件ID
     */
    public AnyLayer onClickToDismiss(final LayerManager.OnLayerClickListener listener, @IdRes int viewId, @IdRes int... viewIds) {
