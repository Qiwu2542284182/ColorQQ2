package me.qiwu.colorqq.library.tablayout;
...
import me.qiwu.colorqq.library.tablayout.listener.CustomTabEntity;
import me.qiwu.colorqq.library.tablayout.listener.OnTabSelectListener;
import me.qiwu.colorqq.library.tablayout.utils.FragmentChangeManager;
import me.qiwu.colorqq.library.tablayout.utils.UnreadMsgUtils;
import me.qiwu.colorqq.library.tablayout.widget.MsgView;
...
//            msgView.setPadding(3, 3, 3, 3);
    ...
    private void addTab(final int position, View tabView) {
        ...
        if (unSelectIconColor!=Color.TRANSPARENT){
...
//                CustomTabEntity tabEntity = mTabEntitys.get(i);
                int color = selected ? selectIconColor : unSelectIconColor;
                if (color!=Color.TRANSPARENT){
                    iv_tab_icon.setColorFilter(color);
                }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            int color = isSelect ? selectIconColor : unSelectIconColor;
            if (color!=Color.TRANSPARENT){
                iv_tab_icon.setColorFilter(color);
            }
